...
(function() {
  var Q, addressMarker, asserters, baseUrl, browseButtonSelector, browser, chai, chaiAsPromised, delay, errorDelay, pageTitle, pollFreq, searchButton, searchFieldPath, searchResultPath, serviceTreeItemSelector, should, typeaheadResultPath, unitMarker, unitNamePopup, wd;
  ...
  describe('Browser test', function() {
    ...
    return describe('Test embedding', function() {
      ...
      startEmbedTest = function(embed) {
        ...
        it('Should use "' + embed.map + '" maplayer', function(done) {
        ...
        return it('Should not display navigation region', function(done) {
      ...
      return describe('Test embedded services', function() {
        var embeds;
        embeds = [
          {
